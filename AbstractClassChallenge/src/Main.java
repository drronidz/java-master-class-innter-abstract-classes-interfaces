public class Main {
    public static void main(String[] args) {
        ...
        // i.e., if you call your abstract class List Item, then it would have 2 member variables of
        // type ListItem that will hold references to next/right and previous/left ListItems.
        ...
        //
        // Note that your are creating your own LinkedList class here, not using the built-in Java one ...
        //
        ...
        // you create classes before referring to them. In previous videos we have often referred to
